...
* Green Team Usability: These are manully checks by the Green Team to test the Blue Teams'
...
* Also if the Red Team is able to capture the flag the Blue Team can send a report back, via a text
 field, to able back points, up to half. These will be judge by the Red and White teams.
